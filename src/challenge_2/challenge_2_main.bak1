...
if __name__ == "__main__":
    ...
    with MissionContext("Startup"):
        ...
        cam_front = AsyncSubscriber("/iris/camera/image_raw", Image, queue_size=1).subscribe()
    ...
    with MissionContext("POI Search"):
        ...
        #while True:
        async for ftemp in cam_font:
            frame_status, img = (True, bridge.imgmsg_to_cv2(ftemp, desired_encoding="bgr8")) # Acquire image from front camera
